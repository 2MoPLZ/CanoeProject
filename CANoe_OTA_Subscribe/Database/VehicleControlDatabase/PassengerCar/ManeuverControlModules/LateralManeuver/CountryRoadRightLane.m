...
Scheduler.Phase{1}.DrivingTask.SubPathCtrlTask.v = 'Lane';

Scheduler.Phase{1}.DrivingTask.RefLane.Comment = 'Reference lane';
Scheduler.Phase{1}.DrivingTask.RefLane.vUnit = '-';
Scheduler.Phase{1}.DrivingTask.RefLane.v = -1;
Scheduler.Phase{1}.DrivingTask.RefLane.ActualSelection = 'Constant';
