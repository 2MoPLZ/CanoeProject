...
ShiftingSpeeds.UpshiftScalingMap.x = [0.5, 1];
ShiftingSpeeds.UpshiftScalingMap.y = [1, 2, 3];
ShiftingSpeeds.UpshiftScalingMap.v = [0.75, 0.8, 0.8; ...
    0.95, 0.97, 0.97];
...
ShiftingSpeeds.DownshiftScalingMap.x = [0.5, 1];
ShiftingSpeeds.DownshiftScalingMap.y = [1, 2];
ShiftingSpeeds.DownshiftScalingMap.v = [0.2, 0.2; ...
    0.2, 0.2];
...
ShiftingSpeeds.UpshiftOffsetMap.y = [1, 2];
...
ShiftingSpeeds.DownshiftOffsetMap.y = [1, 2];
...
ShiftingParameters.GearShiftDelayTime.v = 0.2;
...
ClutchParameters.ClutchEngageEngSpd.v = 140.4395;
...
ClutchParameters.ClutchDisengageEngSpd.v = 78.5398;
...
ClutchParameters.ClutchOpenSlewRate.v = -6;
...
ClutchParameters.ClutchOpeningTime.v = 0.3;
...
AcceleratorPedalParameters.AccPedalOpenSlewRate.v = -5;
